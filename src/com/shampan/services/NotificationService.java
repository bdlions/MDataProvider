...
public class NotificationService {
    ...
    /**
     * This method will update status type to read and return friend notification list
     ...
     */
    public static String updateStatusGetFriendNotifications(String userId, String statusTypeId, String offset, String limit)
    {
        notificationModel.updateStatusFriendNotifications(userId, statusTypeId);
    ...
    /**
     * This method will update general notification status type to read and return general notification list
     * @param userId, user id
     * @param statusTypeId, status type id
     * @param offset, offset
     * @param limit, limit
